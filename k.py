...
while True:
    ...
    # Feltételezzük, hogy a személy az egész képen van, mert nincs objektumdetekció
    face_img = Image.fromarray(frame).convert('L')  # Szürkeárnyalatos
    ...
    draw.text((10,60), f"Emotion: {emotion_label}", fill=(255,255,255), font=font)

    # Megjelenítés framebufferen
